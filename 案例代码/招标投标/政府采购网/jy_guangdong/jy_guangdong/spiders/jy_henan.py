...
class Jy_henanSpider(scrapy.Spider):
    name = 'jy_henan_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['hndzzbtb.hndrc.gov.cn']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(Jy_henanSpider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # python3 -m scrapy crawl jy_henan_spider -a start_time="2019:01:01" -a end_time="2020:02:26"
        # nohup python3 -m scrapy crawl jy_henan_spider -a start_time="2019:01:01" -a end_time="2020:02:25" > /dev/null&
        ...
        _source_info = {
            ...
            'page_1': {
                ...
                # list页面的base地址
                'base_url': 'http://hndzzbtb.hndrc.gov.cn/services/hl/getSelect?',
                ...
                'tos': '工程建设',
                'tos_code': '01',
                'source': '河南省电子招标投标公共服务平台',
                'notice_type': "招标公告",
                'notice_type_code': '0101',
                'area_code': '41',
                'content_code': '1',
                'site_name': '河南省电子招标投标公共服务平台',
                'industry': '',
    ...
    def get_normal_next_page_url(page_index, base_url, ext_param):
        _param = {
            ...
            'timestart': '',
            'timeend': '',
            'categorynum': ext_param['categorynum'],
            'siteguid': '3955b792-fb32-4dc1-8935-49ad516ae6db'
        }
    ...
    def parse_list_page_common(self, response):
        ...
        if response.meta['param']['requests_type'] == "dict":
            ...
            # _return_ = _response_data['return']
            _response_data = json.loads(_response_data['return'])

            # print(isinstance(_response_data, str))
            ...
            for selector in _response_data:
                ...
                try:
                    _item_idx += 1
                    _detail_url = 'http://hndzzbtb.hndrc.gov.cn' + selector['href']
...
class BaseItemCommonParser:
    ...
    def __get_notice_time__(self):
        try:
            ...
            _notice_time = self.selector['infodate']
