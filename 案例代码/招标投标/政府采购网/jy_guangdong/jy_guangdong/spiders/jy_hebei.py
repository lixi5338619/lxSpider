...
class Jy_hebei_Spider(scrapy.Spider):
    name = 'jy_hebei_spider'  # 需要修改成全局唯一的名字
    allowed_domains = ['www.hebeieb.com.cn']  # 需要修改成爬取网站的域名

    def __init__(self, *args, **kwargs):
        super(Jy_hebei_Spider, self).__init__(*args, **kwargs)
    ...
    def start_requests(self):
        ...
        # command example:
        # nohup python3 -m scrapy crawl jy_hebei_spider -a start_time="2019:01:01" -a end_time="2020:02:25" > /dev/null&
        ...
        _source_info = {
            ...
            'page_1': {
                ...
                # list页面的base地址
                'base_url': 'http://www.hebeieb.com.cn/tender/xxgk/',
                ...
                'xpath_of_list': '//div[@class="publicont"]',

                # 获得每一个条目链接地址的xpath
                'xpath_of_detail_url': './div/h4/a/@href',
                ...
                'tos': '工程建设',
                'tos_code': '01',
                'source': '河北省招标投标公共服务平台',
                'notice_type': '招标公告',
                'notice_type_code': '0101',
                'site_name': '河北省招标投标公共服务平台',
                'area_code': '14',
                'content_code': '1',
                'industryName': '',
                'bid_type': 'zbgg.do',
...
class BaseItemCommonParser:
    ...
    def __get_notice_time__(self):
        try:
            ...
            _notice_time = self.selector.xpath('./div/h4/span/text()').extract_first()
    ...
    def __get_title__(self):
        ...
        :return:
        """
        _ret = self.selector.xpath('./div/h4/a/@title').extract_first().replace('\\n', '').strip()
