...
class Jy_jilinSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        _source_info = {
            ...
            'page_1': {
                ...
                # list页面的base地址
                'base_url': 'http://was.jl.gov.cn/was5/web/search?',
                ...
                'tos': '政府采购',
                'tos_code': '02',
                'source': '吉林省公共资源交易公共服务平台',
                'notice_type': "采购公告",
                'notice_type_code': '0201',
                'area_code': '32',
                'content_code': '1',
                'site_name': '吉林省公共资源交易公共服务平台',
                'industry': '工程建设',
                'channelid': '237687',
                'searchword': "gtitle<>'' and gtitle<>'null' and tType='政府采购' and iType='采购公告'",
            ...
            'page_2': {
                ...
                'industry': '工程建设',
                'channelid': '237687',
                'searchword': "gtitle<>'' and gtitle<>'null' and tType='政府采购' and iType='变更公告'",
                'time_type': 6 if self.crawl_mode == CrawlMode.HISTORY else 0,
            },
            'page_3': {
                # 通常会被填充在'source'字段里，有时也可以放在'tos'
                ...
                'industry': '工程建设',
                'channelid': '237687',
                'searchword': "gtitle<>'' and gtitle<>'null' and tType='政府采购'  and iType='中标公告'",
                'time_type': 6 if self.crawl_mode == CrawlMode.HISTORY else 0,
            },
            'page_4': {
                # 通常会被填充在'source'字段里，有时也可以放在'tos'
                ...
                'industry': '工程建设',
                'channelid': '237687',
                'searchword': "gtitle<>'' and gtitle<>'null' and tType='政府采购'  and iType='合同公示'",
                'time_type': 6 if self.crawl_mode == CrawlMode.HISTORY else 0,
            },
            'page_5': {
                # 通常会被填充在'source'字段里，有时也可以放在'tos'
                ...
                'industry': '工程建设',
                'channelid': '237687',
                'searchword': "gtitle<>'' and gtitle<>'null' and tType='政府采购' and iType='单一来源论证公示'",
                'time_type': 6 if self.crawl_mode == CrawlMode.HISTORY else 0,
            },
            'page_6': {
                # 通常会被填充在'source'字段里，有时也可以放在'tos'
                ...
                'industry': '',
                'channelid': '237687',
                'searchword': "gtitle<>'' and gtitle<>'null' and tType='工程建设'   and iType='招标公告'",
                'time_type': 6 if self.crawl_mode == CrawlMode.HISTORY else 0,
            },
            'page_7': {
                # 通常会被填充在'source'字段里，有时也可以放在'tos'
                ...
                'industry': '',
                'channelid': '237687',
                'searchword': "gtitle<>'' and gtitle<>'null' and tType='工程建设'   and iType='变更公告工程'",
                'time_type': 6 if self.crawl_mode == CrawlMode.HISTORY else 0,
            },
            'page_8': {
                # 通常会被填充在'source'字段里，有时也可以放在'tos'
                ...
                'industry': '',
                'channelid': '237687',
                'searchword': "gtitle<>'' and gtitle<>'null' and tType='工程建设'   and iType='中标候选人公示'",
                'time_type': 6 if self.crawl_mode == CrawlMode.HISTORY else 0,
            },
            'page_9': {
                # 通常会被填充在'source'字段里，有时也可以放在'tos'
                ...
                'industry': '',
                'channelid': '237687',
                'searchword': "gtitle<>'' and gtitle<>'null' and tType='工程建设'   and iType='中标结果公告'",
                'time_type': 6 if self.crawl_mode == CrawlMode.HISTORY else 0,
            },
            'page_10': {
                # 通常会被填充在'source'字段里，有时也可以放在'tos'
                ...
                'industry': '',
                'channelid': '237687',
                'searchword': "gtitle<>'' and gtitle<>'null' and tType='土地使用权'    and iType='出让公告'",
                'time_type': 6 if self.crawl_mode == CrawlMode.HISTORY else 0,
            },
            'page_11': {
                # 通常会被填充在'source'字段里，有时也可以放在'tos'
                ...
                'industry': '',
                'channelid': '237687',
                'searchword': "gtitle<>'' and gtitle<>'null' and tType='土地使用权'    and iType='成交宗地'",
                'time_type': 6 if self.crawl_mode == CrawlMode.HISTORY else 0,
            },
            'page_12': {
                # 通常会被填充在'source'字段里，有时也可以放在'tos'
                ...
                'industry': '',
                'channelid': '237687',
                'searchword': "gtitle<>'' and gtitle<>'null' and tType='国有产权'  and iType='挂牌披露'",
                'time_type': 6 if self.crawl_mode == CrawlMode.HISTORY else 0,
            },
            'page_13': {
                # 通常会被填充在'source'字段里，有时也可以放在'tos'
                ...
                'industry': '',
                'channelid': '237687',
                'searchword': "gtitle<>'' and gtitle<>'null' and tType='国有产权'  and iType='交易结果'",
                'time_type': 6 if self.crawl_mode == CrawlMode.HISTORY else 0,
            },
            'page_14': {
                # 通常会被填充在'source'字段里，有时也可以放在'tos'
                ...
                'industry': '',
                'channelid': '237687',
                'searchword': "gtitle<>'' and gtitle<>'null' and tType='股权类产权交易'  and iType='挂牌披露信息'",
                'time_type': 6 if self.crawl_mode == CrawlMode.HISTORY else 0,
            },
            'page_15': {
                # 通常会被填充在'source'字段里，有时也可以放在'tos'
                ...
                'industry': '',
                'channelid': '237687',
                'searchword': "gtitle<>'' and gtitle<>'null' and tType='股权类产权交易'  and iType='交易结果信息'",
                'time_type': 6 if self.crawl_mode == CrawlMode.HISTORY else 0,
            },
            'page_16': {
                # 通常会被填充在'source'字段里，有时也可以放在'tos'
                ...
                'industry': '',
                'channelid': '237687',
                'searchword': "gtitle<>'' and gtitle<>'null' and tType='药械采购'  and iType='采购公告'",
                'time_type': 6 if self.crawl_mode == CrawlMode.HISTORY else 0,
            },
        }
    ...
    def parse_list_page_common(self, response):
        ...
        if response.meta['param']['requests_type'] == "dict":
            ...
            _response_dict = response.text.replace('result(', '').replace(');', '')
...
class BaseItemCommonParser:
    ...
    def __get_notice_time__(self):
        try:
            ...
            _notice_time = self.selector['timestamp']
            _ret = _notice_time
        except:
            _ret = ''
