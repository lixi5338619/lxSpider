...
function Param_encode_detail(m){
  w= aaa.Writer.create()
...
function Param_encode_search(m){
      w= aaa.Writer.create()
...
function req_list(policyType){
    ...
    var requestData=PolicyInfoByTypeIdParam_encode(data).finish().slice();
    return requestData
}

function req_detail(aid){
    data = {
        "id":aid
    }
    return Param_encode_detail(data).finish().slice();
}

function req_search(word){
    data = {
        city: "-1",
        department: "0",
        downtown: "-1",
    ...
    return Param_encode_search(data).finish().slice();
}